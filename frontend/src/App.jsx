...
function App() {
  ...
  if (loading) {
    return <div className="flex flex-col h-[100vh] justify-center items-center text-5xl text-white font-[500]"><h1>Loading...</h1><p className="text-xl text-[silver]">It will take a minute to load<br/>because the backend is hosted with render's free plan which has bad cold starts.</p></div>
  }
